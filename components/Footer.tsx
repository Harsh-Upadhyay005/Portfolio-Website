...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center gap-3 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-500 hover:to-orange-500 text-white px-8 py-4 rounded-2xl font-semibold shadow-xl shadow-yellow-500/25 transition-all"
          >
